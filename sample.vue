...
export default {
  ...
  methods: {
      printout: `
      1. I still think it's good timing at all. covid situation, not easy to do any business.
      2. the pharmacy representative(my client's wife) is not capable to do this. 
      3. no matter how exchange rate drops, just spend it. no need to hold still
      
      if you'd still like give it a try, i have to find clients who's capable to sell.(no guarantee at the moment.)
      I need two things. You don't have to be engaged in sending below. Ask them to send via official channel. 
        - technical specification doc
        - sample. (without sample, almost impossible to discuss)
      `
  }
};
</script>
